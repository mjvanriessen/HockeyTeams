...
public class EditTeamServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String teamCity = request.getParameter("city");
		String teamWins = request.getParameter("wins");
		Integer tempId = Integer.parseInt(request.getParameter("id"));
		
		HockeyTeam teamToUpdate = hth.searchForTeamById(tempId);
		teamToUpdate.setTeamName(teamName);
		teamToUpdate.setTeamCity(teamCity);
		teamToUpdate.setTeamWins(teamWins);
		
		hth.updateTeam(teamToUpdate);
